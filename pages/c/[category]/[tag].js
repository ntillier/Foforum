...
export default function Tag() {
    ...
    function loadMore (erase = false) {
        get(
            'topicsInCategory',
            'query($category: String!, $cursor: String, $tag: String!) { topicsInCategory(category: $category, cursor: $cursor, tag: $tag) { items { ... on Topic { title likesCount repliesCount link answer { id } latest { image username } tags { label id } } } pageInfo { hasNextPage nextCursor } } }',
            {
