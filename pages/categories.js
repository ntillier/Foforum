...
export default function Tag() {
    ...
    function loadMore (erase = false) {
        get(
            'trendingTopics',
            'query($cursor: String) { trendingTopics(cursor: $cursor) { items { ... on Topic { title likesCount repliesCount link answer { id } latest { image username } tags { label id } } } pageInfo { hasNextPage nextCursor } } }',
            {
